...
<div class="form-div">
  <form action="" method="post" id="selectForm" name="selectForm">
    ...
    <!--<?php $_from = $this->_var['start_date_arr']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('k', 'start_date_0_78178900_1442301962');if (count($_from)):
    foreach ($_from AS $this->_var['k'] => $this->_var['start_date_0_78178900_1442301962']):
?>-->
    <?php if ($this->_var['k'] > 0): ?>
    &nbsp;+&nbsp;
    <?php endif; ?>
    <input name="year_month[]" value="<?php echo $this->_var['start_date_0_78178900_1442301962']; ?>" style="width:60px;" onclick="return showCalendar(this, '%Y-%m', false, false, this);" /> 
