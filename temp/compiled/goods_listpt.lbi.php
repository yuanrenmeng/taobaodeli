...
?>
    <?php if ($this->_var['goods']['goods_id']): ?>
     <li>
		<a href="<?php echo $this->_var['goods']['url']; ?>" class="g_bt" target="_blank">抢购&nbsp;&nbsp;<font style="color:#FFF721;">奖金:<?php echo $this->_var['goods']['market_price']; ?></font></a>
             <div class="shangmian">
<a href="<?php echo $this->_var['goods']['url']; ?>" target="_blank"><img src="<?php echo $this->_var['goods']['goods_thumb']; ?>" alt="<?php echo $this->_var['goods']['goods_name']; ?>" width="256" height="256" /></a>

            <p style="font-size:18px;"><?php echo $this->_var['goods']['goods_style_name']; ?><!--<img src="themes/ecmoban_meilishuo/images/hb1.png" width="23" height="30" />--></p>


          </div>
          <div class="dibu"><span> 已抢<b><?php echo $this->_var['goods']['count']; ?>/<?php echo $this->_var['goods']['goods_brief']; ?></b>份</span>
