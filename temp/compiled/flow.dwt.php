...
<link href="themes/ecmoban_meilishuo/fl_sbmt.css" rel="stylesheet" type="text/css">
<style type="text/css">
.main_suc {
	width: 974px;
	margin-top: 0;
...
<div style="height:200px;"></div>
  <div class="biaodan">
    <p>温馨提示：输入商品订单号提交，然后就有机会领取红包和抽奖！</p>
    
      <table  border="0" id="ddnum">
        <tr>
          <td class="td1">提交订单号：</td>
          <td class="td2"><input  type="text" id="dd" value=""/></td>
        </tr>
        <tr>
          <td class="td1">&nbsp;</td>
          <td class="td2"><button    onclick="chdd()" class="tijiao_bt">确认提交</button></td>
        </tr>
      </table>
  ...
  <div class="choujiang"  id="choujiang">
    <ul>
      <li  id="hb" style="display:none;"><img src="themes/ecmoban_meilishuo/images/hb.png" width="100" height="134" onclick="openhb();"/><p><input type="hidden" id="hbct" value="" /><a >点击打开</a></p></li>
      <li id="jp" style="display:none;"><img src="themes/ecmoban_meilishuo/images/jiangpin.png" width="125" height="124" onclick="jp();" /><p><input type="hidden" id="jpct" value="" /><a >点击抽奖</a></p></li>
       <li class="hongbao" id="hongbao" style="display:none"></li>
      <li class="jiangpin" id="jiangpin" style="display:none"></li>
    </ul>
  </div>
  <div style="clear:both"></div>
  
</div>
        <form action="flow.php" method="post" name="theForm" id="theForm" onsubmit="return checkOrderForm(this)"  style="height:0px;">
        <script type="text/javascript">
...
?>
          ...
          <?php if ($this->_var['goods']['is_shipping']): ?>(<span style="color:#FF0000"><?php echo $this->_var['lang']['free_goods']; ?></span>)<?php endif; ?>
              ...
              <td bgcolor="#ffffff"><?php echo nl2br($this->_var['goods']['goods_attr']); ?></td>
              <td bgcolor="#ffffff"><input type="hidden" id="gdstype" value="<?php echo $this->_var['goods']['goods_sn']; ?>" /></td>
              <?php if ($this->_var['show_marketprice']): ?>
              ...
              <td bgcolor="#ffffff" align="right"><?php echo $this->_var['goods']['goods_number']; ?><input type="hidden" id="gdsnum" value="<?php echo $this->_var['goods']['goods_number']; ?>" /></td>
...
?>
            <tr>
              <td bgcolor="#ffffff" valign="top"><input name="shipping" type="radio" value="4"  supportCod="1" insure="0"  checked="checked" />
...
?>
            ...
            <tr>
              <td valign="top" bgcolor="#ffffff"><input type="radio" name="payment" value="2"  isCod="0"  checked="checked" /></td>
...
?>
            ...
            <tr>
              ...
              <td bgcolor="#ffffff">
              <textarea name="postscript" cols="80" rows="3" id="postscript" style="border:1px solid #ccc;"><?php echo htmlspecialchars($this->_var['order']['postscript']); ?></textarea></td>
            </tr>
...
?>
    ...
    <h6><span><?php echo $this->_var['lang']['fee_total']; ?></span></h6>
          <?php echo $this->fetch('library/order_total.lbi'); ?>
           <div align="center" style="margin:8px auto;  display:block;">
            <input type="image" src="themes/ecmoban_meilishuo/images/bnt_subOrder.gif" />
            <input type="hidden" name="step" value="done" />
            </div>
    </div>
    <div style="height:50px; display:none; position:absolute;top:700px; left:700px;" align="center" id="bt"><input type="image" src="themes/ecmoban_meilishuo/images/bt.jpg" /></div>
     <script type="text/javascript" src="themes/ecmoban_meilishuo/js/hbcj.js"></script>
    </form>
        <?php endif; ?>
...
<div style="height:250px;"></div>
  <p>          恭喜您，您的奖金申请已成功提交！</p>
<p> （奖金金额、红包、抽奖奖品将于您的商品确认收货7天后返还到您的账户）</p>
  <div style="clear:both"></div>
 
</div>
        <div class="flowBox" style="margin:0 auto 70px auto; display:none" >
