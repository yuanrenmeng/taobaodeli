...
/* 用户菜单 */
$_LANG['label_welcome'] = "账户信息";
$_LANG['label_profile'] = '用户信息';
$_LANG['label_order'] = "返利明细";
...
$_LANG['process_notic'] = "支付宝/银行卡";
$_LANG['admin_notic'] = "审核信息";
...
/* 会员订单 */
$_LANG['order_list_lnk'] = "返利列表";
$_LANG['order_number'] = '订单编号';
$_LANG['order_addtime'] = "返利申请时间";
$_LANG['order_money'] = "总金额";
$_LANG['order_status'] = "审核状态";
...
/* 订单状态 */
$_LANG['os'][OS_UNCONFIRMED] = '待初审';
$_LANG['os'][OS_CONFIRMED] = '初审通过';
$_LANG['os'][OS_SPLITED] = '初审通过';
$_LANG['os'][OS_SPLITING_PART] = '初审通过';
$_LANG['os'][OS_CANCELED] = '已取消';
$_LANG['os'][OS_INVALID] = '无效';
$_LANG['os'][OS_RETURNED] = '退货';

$_LANG['ss'][SS_UNSHIPPED] = '--';
$_LANG['ss'][SS_PREPARING] = '--';
$_LANG['ss'][SS_SHIPPED] = '--';
$_LANG['ss'][SS_RECEIVED] = '--';
$_LANG['ss'][SS_SHIPPED_PART] = '已发货(部分商品)';
$_LANG['ss'][SS_SHIPPED_ING] = '配货中'; // 已分单

$_LANG['ps'][PS_UNPAYED] = '待终审';
$_LANG['ps'][PS_PAYING] = '--';
$_LANG['ps'][PS_PAYED] = '终审完毕';
